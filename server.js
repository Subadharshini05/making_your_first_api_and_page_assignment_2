...
app.get('/status-info' ,(req,res)=>{
  ...
  switch(code){
    case "200":
      message = "Not Found: The server has not found anything matching the request URI. This is often caused by a missing page or resources."
      break;
    case "201":
      message = "The request was successful, and a new resource was a created as a result."
      break;
    case "204":
    ...
    case "401":
      ...
      break;
    case "403":
      message = "The client does not have permission to access the requested response."
      break;  
    case "404":
    ...
    case "405":
      ...
      break;
    case "429":
      message = "The client has to sent too many requests in a given timeframe, and rate-limiting has been applied."
      break;
    case "500":
